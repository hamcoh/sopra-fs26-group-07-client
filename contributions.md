...
| **@supermqx** | 26.3.2026| https://github.com/hamcoh/sopra-fs26-group-07-server/commit/168f3e953891e4bb9b1a640374c4264272bb370f | Implement backend handling for predefined test cases (#102)| Very relevant because we can now store problems and testcases in the database. Also the repositories have been created  and laid the groundwork so JPA can use CRUD ops. s.t JPA can do e.g findTestCaseById etc. |
